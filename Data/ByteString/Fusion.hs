...
"ByteString loop/loop fusion!" forall em1 em2 start1 start2 arr.
...
"ByteString lazy loop/loop fusion!" forall em1 em2 start1 start2 arr.
...
"ByteString loopArr/loopSndAcc" forall x.
  loopArr (loopSndAcc x) = loopArr x

"ByteString seq/NoAcc" forall (u::NoAcc) e.
  u `seq` e = e

"ByteString loop/loop wrapper elimination" forall loop1 loop2 arr.
